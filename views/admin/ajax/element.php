<div class='vra-element-inputs new added'>
    <textarea class='vra-new' aria-label="<?php echo __('Content %s', $newElementCount + 1); ?>" name='<?php echo $nameBase; ?>[newElements][<?php echo $newElementCount; ?>][content]' value=''></textarea>
